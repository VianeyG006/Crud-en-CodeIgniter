  ...
  <a class="navbar-brand" href="http://localhost/proyecto/public/">
    ...
    <div class="container">
      ...
      <p><table class="table table-striped">
        <thead>
        <th>ID</th><th>Name</th><th colspan="2">Options</th>
        </thead>
        <?php foreach ($genres as $key => $genre): ?>
          ...
          <td><?=$genre->id?></td>
            <td><?=$genre->name?></td><td>
               ...
               <a href="genre/delete/<?=$genre->id?>">Eliminar</a> 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Inserte nuevo genéro</h5>
    ...
    <p><form class="" action="genre/save" method="post">
